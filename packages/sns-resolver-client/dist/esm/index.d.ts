...
export declare function setRegistry<R extends ResponseTypes = undefined>({ caller, node, registry }: {
    caller: Address;
    node: Buffer;
    registry: Address;
}, options?: {
...
export declare function setName<R extends ResponseTypes = undefined>({ caller, node, name }: {
    caller: Address;
    node: Buffer;
    name: Address;
}, options?: {
...
export declare function setText<R extends ResponseTypes = undefined>({ caller, node, text }: {
    caller: Address;
    node: Buffer;
    text: string;
}, options?: {
...
export declare function remove<R extends ResponseTypes = undefined>({ caller, node }: {
    caller: Address;
    node: Buffer;
}, options?: {
    /**
...
export declare function name<R extends ResponseTypes = undefined>({ node }: {
    node: Buffer;
}, options?: {
    /**
     * The fee to pay for the transaction. Default: 100.
...
export declare function text<R extends ResponseTypes = undefined>({ node }: {
    node: Buffer;
}, options?: {
    /**
     * The fee to pay for the transaction. Default: 100.
...
export declare function registry<R extends ResponseTypes = undefined>({ node }: {
    node: Buffer;
}, options?: {
    /**
     * The fee to pay for the transaction. Default: 100.
