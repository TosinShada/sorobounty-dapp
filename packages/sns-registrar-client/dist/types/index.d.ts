...
export declare function initialize<R extends ResponseTypes = undefined>({ registry, admin, base_node }: {
    registry: Address;
    admin: Address;
    base_node: Buffer;
}, options?: {
...
export declare function addController<R extends ResponseTypes = undefined>({ caller, controller }: {
    caller: Address;
    controller: Address;
}, options?: {
    /**
...
export declare function removeController<R extends ResponseTypes = undefined>({ caller, controller }: {
    caller: Address;
    controller: Address;
}, options?: {
    /**
...
export declare function transferContractOwnership<R extends ResponseTypes = undefined>({ caller, new_owner }: {
    caller: Address;
    new_owner: Address;
}, options?: {
    /**
...
export declare function setResolver<R extends ResponseTypes = undefined>({ caller, resolver }: {
    caller: Address;
    resolver: Address;
}, options?: {
    /**
...
export declare function setRecord<R extends ResponseTypes = undefined>({ caller, owner, resolver, ttl }: {
    caller: Address;
    owner: Address;
    resolver: Address;
    ttl: u32;
...
export declare function nameExpiry<R extends ResponseTypes = undefined>({ name }: {
    name: Buffer;
}, options?: {
    /**
     * The fee to pay for the transaction. Default: 100.
...
export declare function nameOwner<R extends ResponseTypes = undefined>({ name }: {
    name: Buffer;
}, options?: {
    /**
     * The fee to pay for the transaction. Default: 100.
...
export declare function available<R extends ResponseTypes = undefined>({ name }: {
    name: Buffer;
}, options?: {
    /**
     * The fee to pay for the transaction. Default: 100.
...
export declare function isController<R extends ResponseTypes = undefined>({ caller }: {
    caller: Address;
}, options?: {
    /**
     * The fee to pay for the transaction. Default: 100.
...
export declare function register<R extends ResponseTypes = undefined>({ caller, owner, name, duration }: {
    caller: Address;
    owner: Address;
    name: Buffer;
    duration: u64;
...
export declare function renew<R extends ResponseTypes = undefined>({ caller, name, duration }: {
    caller: Address;
    name: Buffer;
    duration: u64;
}, options?: {
